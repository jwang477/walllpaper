<template>
  <div>
    ...
    <div style="margin-top: 5px">
      <el-button type="primary" style="margin-left: 5px" @click="detail(null)" icon="el-icon-circle-plus-outline">新增
      </el-button>
    </div>
    <div style="margin-top: 10px">
      ...
      >
        ...
        <el-table-column label="操作" min-width="180">
          <template slot-scope="scope">
            <el-button type="primary" @click="detail(scope.row.wallId)" icon="el-icon-edit">编辑</el-button>
            <el-button type="danger" @click="remove(scope.row.wallId)" icon="el-icon-delete">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
  ...
  methods: {
    ...
    detail(val) {
      if (val){
        ...
        //不开启新页面跳转
        // this.$router.push("/wallDetail?"+val)
      }else{
        //打开新页面
        let routeUrl = this.$router.resolve({
          path: "/wallDetail",
